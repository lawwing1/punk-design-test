...
const HomePage = (): JSX.Element => {
    ...
    useEffect(() => {
        if (!isScroll) return;
        document.getElementsByClassName("fullpage")[0].addEventListener("mousewheel", windowmousewheel, false);
        return () => {
            document.getElementsByClassName("fullpage")[0].removeEventListener("mousewheel", windowmousewheel, false);
        }
    }, [currentPos, isScroll])
